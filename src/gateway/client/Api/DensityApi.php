...
class DensityApi
{
    ...
    /**
     * Operation createdensity
     *
     * Create a new density
     *
     * @param \Gateway\Client\Model\Density $body Data used to create a new density (required)
     * @throws \Gateway\Client\ApiException on non-2xx response
     * @return void
     */
    public function createdensity($body)
    {
        list($response) = $this->createdensityWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation createdensityWithHttpInfo
     *
     * Create a new density
     *
     * @param \Gateway\Client\Model\Density $body Data used to create a new density (required)
     ...
     */
    public function createdensityWithHttpInfo($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling createdensity');
        }
        // parse inputs
